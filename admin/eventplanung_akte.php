                    ...
                    <div class="bootstrap-timepicker">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control float-right" id="reservationtime"  name="work_time_<?php echo $employee['id']; ?>" id="reservationtime<?php echo $employee['id']; ?>" value="<?php echo htmlspecialchars($employee['work_time']); ?>"/>                            </div>
                          <!-- /.input group -->
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    <?php foreach ($employees as $employee) { ?>
        // Sicherstellen, dass der datetimepicker für "Maximal da bis" richtig funktioniert
