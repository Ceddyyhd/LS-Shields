...
if (isset($_POST['historyData']) && isset($_POST['totalData'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO finanzen_history (user_id, betrag, art, notiz) VALUES (?, ?, ?, ?)");
    $stmt->execute([$historyData['user_id'], $historyData['betrag'], $historyData['art'], $historyData['notiz']]);
