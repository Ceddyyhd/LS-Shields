...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Bei GET-Anfragen keine CSRF-Überprüfung erforderlich, falls nur Informationen abgerufen werden
    // Optional: Du kannst hier auch andere Validierungen einfügen, falls erforderlich
} else {
